...
import { Folder, Trash2, Users, LayoutDashboard, LogOut, Aperture, History, Bell, Trash, X, Check, ArrowRight, ShieldAlert, Laptop, Eye } from 'lucide-react';
...
export default function Layout({ user, role, fullName }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans flex">
      <aside className="w-64 bg-slate-900 flex flex-col border-r border-slate-800 h-screen sticky top-0">
      ...
      <main className="flex-1 min-w-0 flex flex-col h-screen overflow-hidden">
        <div className="flex-1 flex overflow-hidden">
          ...
          {logsOpen && (
            <div className="w-80 border-l border-slate-200 bg-white flex flex-col h-full animate-in slide-in-from-right duration-200">
